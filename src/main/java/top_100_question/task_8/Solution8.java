...
is either. This determines if the final result is negative or positive respectively.
...
in the range. Specifically, integers less than -231 should be clamped to -231,
